...
export class reimagined_crystal_maiden_frostbite extends BaseAbility {
	...
	OnSpellStart(scepter?: boolean): void {
		...
		} // Reimagination: Igloo Frosting: Can be cast on an ally, rooting it and increasing Arcane's Auras effect on that ally by 10 times. Can be help-disabled. No damage is done to a rooted ally. Procs Frost Emanation on nearby enemies.
		else {
