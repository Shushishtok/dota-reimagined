...
export class reimagined_antimage_mana_break extends BaseAbility {
	...
	ReimaginedEnergyBlastPulse(isTalentProc: boolean): void {
		...
		const enemies = FindUnitsAroundUnit(this.caster, this.caster, this.energy_blast_radius!, UnitTargetTeam.ENEMY, UnitTargetType.HERO + UnitTargetType.BASIC, UnitTargetFlags.MANA_ONLY);
