...
export class reimagined_antimage_blink extends BaseAbility {
	...
	ReimaginationReaction() {
		...
		const enemies = util.FindUnitsAroundUnit(this.caster, this.caster, this.reaction_radius!, UnitTargetTeam.ENEMY, UnitTargetType.HERO + UnitTargetType.BASIC, UnitTargetFlags.NONE);
