...
export class reimagined_bristleback_quill_spray extends BaseAbility {
	...
	kill_responses: string[] = [
		"bristleback_bristle_quill_spray_01",
		"bristleback_bristle_quill_spray_02",
		"bristleback_bristle_quill_spray_03",
		"bristleback_bristle_quill_spray_04",
		"bristleback_bristle_quill_spray_05",
		"bristleback_bristle_quill_spray_06",
	];
