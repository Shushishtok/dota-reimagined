...
export class reimagined_sven_storm_bolt extends BaseAbility {
	...
	cast_responses: string[] = [
		"sven_sven_ability_stormbolt_01", // 50% chance on cast
	...
	impact_responses: string[] = [
		"sven_sven_ability_teleport_01", // 20% chance on impact, interrupting a teleport
	...
	ReimaginedMomentumPunchThink(projectileID: ProjectileID) {
		...
		} // Compare location and accumulate distance
		else {
