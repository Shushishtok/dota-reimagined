...
export class modifier_reimagined_crystal_maiden_frostbite_debuff extends BaseModifier {
	...
	DeclareFunctions(): ModifierFunction[] {
		return [ModifierFunction.TOOLTIP, ModifierFunction.TOOLTIP2, ModifierFunction.DISABLE_TURNING, ModifierFunction.HP_REGEN_AMPLIFY_PERCENTAGE, ModifierFunction.MP_REGEN_AMPLIFY_PERCENTAGE];
	}
	...
	CheckState(): Partial<Record<ModifierState, boolean>> {
		return { [ModifierState.ROOTED]: true, [ModifierState.INVISIBLE]: false, [ModifierState.DISARMED]: true };
	}
