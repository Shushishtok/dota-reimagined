...
export class modifier_reimagined_slardar_sprint_buff extends BaseModifier
{
    ...
    ReimaginedFinishStrong(): void
    {
        ...
        if (this.parent.IsStunned() || this.parent.IsOutOfGame() || this.parent.IsRooted() || this.parent.IsHexed() || this.parent.IsCurrentlyHorizontalMotionControlled() || this.parent.IsCurrentlyVerticalMotionControlled()) return;
