...
import {
    CreateBagOfGoldInPosition,
    CreateItemInPosition,
    GenerateRandomConsumableItem,
    IsInRiver,
    IsStunModifier,
} from "../../../lib/util";
    ...
    ReimaginedBasherChain(current_duration: number, target: CDOTA_BaseNPC): number {
        ...
        if (target.IsStunned()) {
            ...
            if (modified_duration) {
                ...
                this.particle_basher_chain_fx = ParticleManager.CreateParticle(
                    this.particle_basher_chain,
                    ParticleAttachment.CUSTOMORIGIN,
                    target
                );
                ParticleManager.SetParticleControlEnt(
                    this.particle_basher_chain_fx,
                    0,
                    target,
