...
export class modifier_reimagined_slardar_puddle_thinker extends BaseModifier
{
    ...
    GetAuraRadius() {return this.puddle_radius!}
    GetAuraSearchFlags() {return UnitTargetFlags.INVULNERABLE + UnitTargetFlags.OUT_OF_WORLD + UnitTargetFlags.NOT_ILLUSIONS}
    GetAuraSearchTeam() {return UnitTargetTeam.FRIENDLY}
    GetAuraSearchType() {return UnitTargetType.HERO}
    GetModifierAura() {return this.modifier_puddle_buff}
}
