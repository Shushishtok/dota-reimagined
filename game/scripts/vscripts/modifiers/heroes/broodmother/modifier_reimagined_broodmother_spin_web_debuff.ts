...
export class modifier_reimagined_broodmother_spin_web_debuff extends BaseModifier {
	...
	ReimaginedTalentTangled() {
		if (HasTalent(this.caster, BroodmotherTalents.BroodmotherTalent_3)) {
			...
			if (!this.talent_3_move_speed_slow_per_stack)
				this.talent_3_move_speed_slow_per_stack = GetTalentSpecialValueFor(this.caster, BroodmotherTalents.BroodmotherTalent_3, "move_speed_slow_per_stack");
