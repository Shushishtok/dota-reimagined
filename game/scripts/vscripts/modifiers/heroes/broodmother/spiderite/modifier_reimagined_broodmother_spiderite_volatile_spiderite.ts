...
export class modifier_reimagined_broodmother_spiderite_volatile_spiderite extends BaseModifier {
	...
	ReimaginedVolatileSpideriteExplosion() {
		...
		const enemies = FindUnitsAroundUnit(this.parent, this.parent, this.volatile_spiderite_radius!, UnitTargetTeam.ENEMY, UnitTargetType.HERO + UnitTargetType.BASIC, UnitTargetFlags.NONE);
