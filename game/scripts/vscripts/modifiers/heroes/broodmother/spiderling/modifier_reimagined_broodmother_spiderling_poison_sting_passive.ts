...
export class modifier_reimagined_broodmother_spiderling_poison_sting_passive extends BaseModifier {
	...
	ReimaginedVolatileSpiderlingsExplosion() {
		...
		const enemies = FindUnitsAroundUnit(this.parent, this.parent, this.volatile_spiderling_radius!, UnitTargetTeam.ENEMY, UnitTargetType.HERO + UnitTargetType.BASIC, UnitTargetFlags.NONE);
