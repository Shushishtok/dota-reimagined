...
export class modifier_reimagined_broodmother_spiderking_hardened_brood_aura extends BaseModifier
{
    ...
    GetAuraSearchFlags() {return UnitTargetFlags.OUT_OF_WORLD + UnitTargetFlags.PLAYER_CONTROLLED}
    GetAuraSearchTeam() {return UnitTargetTeam.FRIENDLY}
    GetAuraSearchType() {return UnitTargetType.BASIC}
    GetModifierAura() {return this.modifier_buff}
}
