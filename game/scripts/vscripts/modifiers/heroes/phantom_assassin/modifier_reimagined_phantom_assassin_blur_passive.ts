...
export class modifier_reimagined_phantom_assassin_blur_passive extends BaseModifier
{
    ...
    ReimaginedTurnedYourBlade(event: ModifierAttackEvent)
    {
        ...
        if (!event.attacker.HasModifier(modifier_reimagined_phantom_assassin_blur_turned_blade_cd.name))
        {
            ...
            event.attacker.AddNewModifier(this.parent, this.ability, modifier_reimagined_phantom_assassin_blur_turned_blade_cd.name, {duration: this.turned_blade_internal_cooldown});
    ...
    ReimaginedTalentImmaterialGirlEvasion(attacker: CDOTA_BaseNPC): number
    {
        ...
        {
            if (!this.talent_5_evasion_pct) this.talent_5_evasion_pct = util.GetTalentSpecialValueFor(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_5, "talent_5_evasion_pct");
    ...
    ReimaginedTalentImmaterialGirlRegister(attacker: CDOTA_BaseNPC)
    {
        ...
        {
            if (!this.talent_5_evasion_duration) this.talent_5_evasion_duration = util.GetTalentSpecialValueFor(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_5, "talent_5_evasion_duration");
            attacker.AddNewModifier(this.caster, this.ability, "modifier_reimagined_phantom_assassin_talent_5_debuff", {duration: this.talent_5_evasion_duration});
        }
    }
    ...
    ReimaginedTalentSoftOnTheEye(): void
    {
        ...
        if (util.HasTalent(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_6))
        {
            ...
            if (!this.talent_6_search_radius) this.talent_6_search_radius = util.GetTalentSpecialValueFor(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_6, "talent_6_search_radius");
            if (!this.talent_6_blur_duration) this.talent_6_blur_duration = util.GetTalentSpecialValueFor(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_6, "talent_6_blur_duration");
            if (!this.talent_6_blur_cooldown) this.talent_6_blur_cooldown = util.GetTalentSpecialValueFor(this.caster, PhantomAssassinTalents.PhantomAssassinTalent_6, "talent_6_blur_cooldown");
            ...
            const enemies = util.FindUnitsAroundUnit(this.caster,
                                                    ...
                                                    UnitTargetFlags.MAGIC_IMMUNE_ENEMIES + UnitTargetFlags.FOW_VISIBLE + UnitTargetFlags.NO_INVIS + UnitTargetFlags.OUT_OF_WORLD + UnitTargetFlags.INVULNERABLE);
            ...
            // Blur!
            this.caster.AddNewModifier(this.caster, this.ability, "modifier_reimagined_phantom_assassin_blur_active", {duration: this.talent_6_blur_duration})

            // Give self the cooldown
            this.caster.AddNewModifier(this.caster, this.ability, "modifier_reimagined_phantom_assassin_talent_6_cooldown", {duration: this.talent_6_blur_cooldown});
        }
    }
}
