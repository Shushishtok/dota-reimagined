...
export class modifier_reimagined_drow_ranger_hypothermia extends BaseModifier {
	...
	DeclareFunctions(): ModifierFunction[] {
		return [ModifierFunction.HEALTH_REGEN_PERCENTAGE, ModifierFunction.ON_DEATH, ModifierFunction.TOOLTIP];
	}
	...
	OnDeath(event: ModifierInstanceEvent) {
		...
		// Find nearby enemies
		const enemies = FindUnitsAroundUnit(this.caster, this.parent, this.shard_burst_damage_radius!, UnitTargetTeam.ENEMY, UnitTargetType.HERO + UnitTargetType.BASIC, UnitTargetFlags.NONE);
