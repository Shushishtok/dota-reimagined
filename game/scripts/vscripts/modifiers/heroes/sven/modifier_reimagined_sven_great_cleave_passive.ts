...
export class modifier_reimagined_sven_great_cleave_passive extends BaseModifier {
	...
	DeclareFunctions(): ModifierFunction[] {
		return [ModifierFunction.ON_ATTACK_LANDED, ModifierFunction.ON_ATTACK_RECORD_DESTROY];
	}
	...
	OnAttackLanded(event: ModifierAttackEvent): void {
		...
		// Great Cleave
		const numOfEnemiesHit = util.CustomCleaveAttack(
			this.parent,
