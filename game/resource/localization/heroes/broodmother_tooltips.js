...
function GenerateLocalizationData() {
    ...
    Modifiers.push({
        ...
        name: "Spawn Spiderlings",
        description: "If killed, will spawn {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} Spiderlings."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_avenger_buff",
        name: "Avenger",
        description: "Increases base damage by {" + "MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE" /* BASEDAMAGEOUTGOING_PERCENTAGE */ + "}%."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Poison Sting",
        description: "Ticking for {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} damage per second, slowing by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}. Poison will burst when accumulating {" + "MODIFIER_PROPERTY_TOOLTIP2" /* TOOLTIP2 */ + "} stacks."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Spawn Spiderite",
        description: "If killed, will spawn a Spiderite. If {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} stacks are accumulated, a Spiderling will spawn instead."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Spin Web",
        description: "Increasing health regen by {" + "MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT" /* HEALTH_REGEN_CONSTANT */ + "} and movement speed by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}%. Attack speed increased by {" + "MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT" /* ATTACKSPEED_BONUS_CONSTANT */ + "}. Spiderlings and Spiderites also gain {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "}% damage reduction."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_spin_web_debuff",
        name: "Spin Web",
        description: "Inside an enemy's web. Visible to the enemy team for {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} seconds when stepping in a new web."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Incapacitating Bite",
        description: "Miss chance increased by {" + "MODIFIER_PROPERTY_MISS_PERCENTAGE" /* MISS_PERCENTAGE */ + "} and movement speed reduced by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}%. Also reduces attack speed by {" + "MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT" /* ATTACKSPEED_BONUS_CONSTANT */ + "} and increases cast time by {" + "MODIFIER_PROPERTY_CASTTIME_PERCENTAGE" /* CASTTIME_PERCENTAGE */ + "}%."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_incapacitating_bite_webbed_up_counter",
        name: "Webbed Up Counter",
        description: "Accumulates stacks when you are attacked while standing on a web. Reaching {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} stacks will cause you to become rooted.",
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_incapacitating_bite_webbed_up_debuff",
        name: "Webbed Up",
        description: "Rooted and missing {" + "MODIFIER_PROPERTY_MISS_PERCENTAGE" /* MISS_PERCENTAGE */ + "}% of attacks."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Insatiable Hunger",
        description: "Damage increased by {" + "MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE" /* PREATTACK_BONUS_DAMAGE */ + "} and lifestealing {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "}%. Nearby spiderlings also gain bonus damage and lifesteal."
    });
    Modifiers.push({
    ...
    Modifiers.push({
        ...
        name: "Feed The Brood",
        description: "Health is increased by {" + "MODIFIER_PROPERTY_HEALTH_BONUS" /* HEALTH_BONUS */ + "} from killing enemies while Insatiable Hunger is active."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_insatiable_hunger_feed_brood_unit_heal",
        name: "Feed The Brood",
        description: "Healed by {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} every second."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_insatiable_hunger_queen_of_brood_buff",
        name: "Queen of the Brood",
        description: "Damage increased by {" + "MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE" /* PREATTACK_BONUS_DAMAGE */ + "} and lifestealing {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "}%."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Venom Stinger",
        description: "Slowed by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}% and bursting every {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} seconds."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Hardened Brood Aura",
        description: "Damage resistance increased by {" + "MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE" /* INCOMING_DAMAGE_PERCENTAGE */ + "}%."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Silken Bola",
        description: "Rooted. Taking {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} damage per second."
    });
    Talents.push({
    ...
    Modifiers.push({
        ...
        name: "Weblings",
        description: "Attack speed increased by {" + "MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT" /* ATTACKSPEED_BONUS_CONSTANT */ + "}."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_broodmother_talent_8_buff",
        name: "Feast Frenzy",
        description: "Attack speed increased by {" + "MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT" /* ATTACKSPEED_BONUS_CONSTANT */ + "} and lifesteal amplification increased by {" + "MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE" /* LIFESTEAL_AMPLIFY_PERCENTAGE */ + "}%."
    });
