	...
	Abilities.push({
		...
		reimagined_effects: [
...

			{
				title: "Finish Strong",
				description:
					"When Guardian Sprint ends, Slardar moves ${finish_strong_distance} units forward over the duration of ${finish_strong_duration} seconds, dragging enemies in front of him. Upon reaching the landing position, Slardar deals ${finish_strong_damage} physical damage to all enemy units in ${finish_strong_radius} radius and stunning them for ${finish_strong_stun_duration} seconds.",
			},

			{
				title: "Watery Comfort",
				description:
					"Passively reduces the cooldown of Guardian Sprint by ${watery_comfort_cd_redcution} every ${watery_comfort_interval} seconds Slardar is considered in the river. Additionally, river bonuses linger for ${watery_comfort_river_bonus_linger} seconds after leaving a river or a puddle.",
			},
		],
		...
		notes: ["Activating this ability doesn't interrupt channeling abilities."],
		...
		talents: [
			{
				name: "Tail Whack",
				description:
					"Finish Strong deals ${bonus_damage} physical damage to all enemies in ${radius} radius of the landing position. Enemies that weren't stunned by it are instead slowed by ${slow_pct}% for the same duration.",
...

			{
				name: "Hydro Pump",
				description:
					"When Splash Attack projectiles land at their target positions, a Slithereen Crush is cast on their location, utilizing river values. Those projectiles cannot create additional puddles.",
		...
		reimagined_effects: [
			{
				title: "Splash Attack",
				description:
					"When Slithereen Crush is cast while the caster is considered in the river, the radius of this ability increases to ${splash_attack_radius}. Additionally, throws ${splash_attack_puddle_count} projectiles of water to random locations in ${splash_attack_puddle_search_radius} range around the caster, each forming a ${splash_attack_puddle_radius} radius puddle for ${splash_attack_puddle_duration} seconds.",
			},
