		...
		reimagined_effects: [
			{
				title: "Wings Out",
				description:
					"Passively applies Dark Ascension's bonuses when Dead of Night's power scale is at least ${wings_out_stack_threshold} stacks. The bonus damage granted by Wings Out is ${wings_out_damage_pct}% of Dark Ascension's damage.",
			},
		],
		notes: ["Wings Out is disabled when Dark Ascension is active."],
	...
	Talents.push({
		...
		talents: [
...

			{
				name: "Feed The Night",
				description:
					"Each enemy hero that dies while inside Crippling Fear's aura extends its duration by ${hero_duration_extend} seconds. Units extends it by ${unit_duration_extend} seconds instead.",
...

			{
				...
				description:
					"Enemies that are affected by Crippling Fear for over ${application_threshold} seconds have Break applied on them and take ${incoming_damage_increase}% more damage from all sources until they lose the aura debuff.",
...

			{
				...
				description:
					"During the night, Night Stalker is passively invisible while not in vision range of enemy heroes. Units closer than ${proximity_distance} units to Night Stalker will also reveal him. This detection occurs regardless of obstacles between Night Stalker and his enemies.",
...

			{
				name: "Flight Muscles",
				description:
					"Wings Out is applied when Night Stalker has at least ${talent_stacks_threshold} Dead of Night stacks. In addition, while Dark Ascension is active, his move speed also increases by an additional ${dark_ascension_bonus_ms_pct}%.",
...

			{
				name: "Midnight Peak",
				description:
					"While Night Stalker has at least ${talent_stacks_threshold} Dead of Night stacks, grants Night Stalker ${damage_reduction_pct}% damage reduction, ${status_resist_pct}% status resistance and ${damage_amp_pct}% outgoing damage from all sources.",
