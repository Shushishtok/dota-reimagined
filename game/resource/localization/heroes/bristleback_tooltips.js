...
function GenerateLocalizationData() {
    ...
    Modifiers.push({
        ...
        name: "Viscous Nasal Goo",
        description: "Losing {" + "MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS" /* PHYSICAL_ARMOR_BONUS */ + "} armor and slowed by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}%."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Quill Spray",
        description: "Each stack increases damage taken from Quill Spray by {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "}."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_bristleback_quill_spray_needle_spreader",
        name: "Needle Spreader",
        description: "Rooted and disarmed. Firing a wave of quills at nearby enemies every {f" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} seconds."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        description: "Uses back's damage reduction values for attacks on the side. Slowed by {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}% movespeed and {" + "MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT" /* ATTACKSPEED_BONUS_CONSTANT */ + "} attack speed, but gains {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "}% additional bonus damage reduction."
    });
    Abilities.push({
    ...
    Modifiers.push({
        ...
        name: "Warpath",
        description: "Moving {" + "MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE" /* MOVESPEED_BONUS_PERCENTAGE */ + "}% faster and dealing {" + "MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE" /* PREATTACK_BONUS_DAMAGE */ + "} bonus damage."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_bristleback_warpath_passive",
        name: "Anger Burst Counter",
        description: "Taking {" + "MODIFIER_PROPERTY_TOOLTIP" /* TOOLTIP */ + "} accumulated damage generates a Warpath stack."
    });
    Modifiers.push({
        modifier_classname: "modifier_reimagined_bristleback_warpath_simmer_down",
        name: "Simmer Down",
        description: "Increases damage resistance from all directions by {" + "MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE" /* INCOMING_DAMAGE_PERCENTAGE */ + "}%, but cannot generate Warpath stacks while this buff is active."
    });
    Abilities.push({
