...
interface HeroTalents
{
    ...
    talents: Array<TalentLocalization>;
}

interface TalentLocalization
{
    name: string;
    description: string;
    lore: string;
...
export class LocalizationCompiler
{
    ...
    TalentArray: Array<HeroTalents> = new Array<HeroTalents>();
    ...
    OnLocalizationDataChanged()
    {
        ...
        fs.truncate(this.addon_english_filepath, () =>
        {
            ...
            // Go over talents
            for (const hero_talent_list of this.TalentArray)
            {
                ...
                for (const talent of hero_talent_list.talents)
                {
                    ...
                    // Talent description
                    const talent_description = this.TransformForLocalization(talent.description, false);
