class PickScreen
{
    ...
    RemoveTalentIcon()
    {
        ...
        const strategyPanel = this.GetContextPanel().FindChildTraverse("PreGame")!.FindChildTraverse("MainContents")!.FindChildTraverse("ScreenContainer")!.FindChildTraverse("StrategyScreen")!.FindChildTraverse("SelectedHeroAbilities")!;
